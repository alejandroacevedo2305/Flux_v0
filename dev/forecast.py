...
SERIES = [10, 14, 12, 17, 5, 11]

forecaster_ttp = ForecasterTTP(dataset=dataset, series=SERIES, atenciones_diarias_minimas=1)

# Genera una proyeccion de demanda, 
demandas_proyectadas_q = forecaster_ttp.proyectar_demanda_SARIMAX('2023-08-15').demandas_proyectada_cuantizadas()
demandas_proyectadas_q = ForecasterTTP.un_dia('2023-08-15', demandas_proyectadas_q) # Retorna solo un dia
demandas_proyectadas_q
